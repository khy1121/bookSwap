...
const TABS = [
  ...
  { href: "/chats", label: "채팅", icon: "icon-[lucide--message-circle]", match: (p: string) => p.startsWith("/chats") },
  { href: "/my", label: "내 거래", icon: "icon-[lucide--user]", match: (p: string) => p.startsWith("/my") || p.startsWith("/login") },
];
