...
## 헤더 라벨 정책 (PR #20·#21)
- 마우스 기기(`@media(hover:hover)`): 아이콘만, 호버·포커스 시 라벨 펼침
- 터치 기기: 학과·내 거래는 아이콘+라벨 상시, 채팅(배지 있음)·로그아웃은 아이콘만 → 360px에서도 한 줄
- 390px 검수(iframe 뷰포트): 홈·학과 스플릿·과목 상세(하단 CTA)·로그인·등록·내 거래·채팅 목록 정상. 내 거래 액션 행 들여쓰기 제거
